...
DDB のようなメモリ集約型アプリケーションでは，
応答速度の向上を目的として多くのデータをメモリ上にキャッシュするため，
肥大化したメモリ使用量が総移送時間の長期化を招く\cite{ibrahimOptimizedPrecopyLive2011a}．
...
Improving the live migration pro
